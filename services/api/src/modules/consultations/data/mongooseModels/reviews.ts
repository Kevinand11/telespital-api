...
import { ReviewChangeStreamCallbacks } from '@utils/changeStreams/consultations/reviews'
...
export const Review = mongoose.model<ReviewFromModel>('ConsultationsReview', ReviewSchema)
